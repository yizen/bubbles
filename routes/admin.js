...
module.exports = function(app){
	...
	app.get('/admin/elasticsearch/reindexReference/', function (req, res) {
		elasticSearch.reindexReferenceWines(function(){res.redirect('/admin/elasticsearch/')});
	});
	
	app.get('/admin/elasticsearch/reindexWine/', function (req, res) {
		elasticSearch.reindexWines(function(){res.redirect('/admin/elasticsearch/')});
	});
	
	app.get('/admin/elasticsearch/reindexProducer/', function (req, res) {
		elasticSearch.reindexProducers(function(){res.redirect('/admin/elasticsearch/')});
	});
};